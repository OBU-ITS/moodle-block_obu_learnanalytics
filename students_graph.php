            ...
            // echo "</pre>";
                ...
                switch ($chartType) {
                    case "ezsessions":
                        ...
                        //$plot3Counts[] = $row["mean_ez_sessions"] ?? 0;
                        break;
                    case "ezduration":
                        $plot1Counts[] = $row["ez_duration_total"] ?? 0;
                        $plot2Counts[] = $row["avg_ez_duration_total"] ?? 0;
                        //$plot3Counts[] = $row["mean_ez_duration_total"] ?? 0;
                        break;
                    case "ezsize":
                        $plot1Counts[] = $row["ez_size"] ?? 0;
                        $plot2Counts[] = $row["avg_ez_size"] ?? 0;
                        //$plot3Counts[] = $row["mean_ez_size"] ?? 0;
                        break;
                    case "vlesessions":
                        $plot1Counts[] = $row["vle_sessions"] ?? 0;
                        $plot2Counts[] = $row["avg_vle_sessions"] ?? 0;
                        //$plot3Counts[] = $row["mean_vle_sessions"] ?? 0;
                        break;
                    case "vleduration":
                        $plot1Counts[] = $row["vle_duration_minutes"] ?? 0;
                        $plot2Counts[] = $row["avg_vle_duration_minutes"] ?? 0;
                        //$plot3Counts[] = $row["mean_vle_duration_minutes"] ?? 0;
                        break;
                    case "vleviews":
                        $plot1Counts[] = $row["vle_page_hits"] ?? 0;
                        $plot2Counts[] = $row["avg_vle_page_hits"] ?? 0;
                        //$plot3Counts[] = $row["mean_vle_page_hits"] ?? 0;
                        break;
                    case "loansline":
                    case "loansbar":
                    case "loanscomb":
                    ...
                    case "attsessions":
                        ...
                        //$plot3Counts[] = $row["mean_attendance_sessions"] ?? 0;
                        break;
                    case "attduration":
