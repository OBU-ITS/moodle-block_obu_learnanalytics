...
$string['ws_bearer_token_demo'] = 'Demonstration Bearer Token';
$string['ws_bearer_token_demo_info'] = 'The Bearer Token to trigger Web services to obfusticate the student data';
